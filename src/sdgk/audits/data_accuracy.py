...
from sdgk.indexes.region import (
    DEFAULT_REGION_DB_PATH,
    DEFAULT_REGION_META_PATH,
    connect_region_index,
    location_evidence_id,
)
from sdgk.indexes.subject import DEFAULT_DB_PATH, DEFAULT_META_PATH, connect_index, make_evidence_id, parse_subject_requirement
