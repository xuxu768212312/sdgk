...
**2020-2024 历史汇总**：`历史分数线_2020-2024.json` 来自山东省教育招生考试院官方页面图片公告转录，质量等级 B；保留官方页面、图片文件和 SHA256 证据，可作为历史趋势与正式方案辅助依据，正式填报仍以当年最新公告为准。
...
- 志愿计划：5 年 × 4 类批次全部完整
- 分数线：2025 为考试院 PDF 提取；2020-2024 为考试院官方图片公告转录并保留 SHA256 证据
- 选科要求：2024 版与 2027 版本/专科均已结构化

### 已知问题

1. **官方空值不补数**：投档表 5 条官方空最低位次、志愿计划 63 条官方空计划数已登记例外清单，不得自动填补或进入概率/计划数计算
2. **major_name 含备注**：志愿计划的专业名称包含校区、中外合作、单科要求等备注信息，未进一步拆分
3. **体育类投档表未纳入**：投档表数据集仅含普通类，体育类需单独处理
4. **processed 元数据持续补强**：后续新增数据仍应统一加入 source_url、publisher、quality_level、verification_status 字段
