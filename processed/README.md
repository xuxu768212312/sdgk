...
- `历史分数线_2020-2024.json` — 2020-2024 历史汇总，当前为互联网公开数据整理，需回查考试院后才能作正式依据
...
**2020-2024 使用限制**：`历史分数线_2020-2024.json` 当前质量等级为 D，仅用于趋势线索。正式引用前必须回查山东省教育招生考试院对应年度页面或公告，并在元数据中升级 `quality_level` 与 `verification_status`。
...
4. **2020-2024 分数线为 D 级线索**：已有历史汇总，但正式引用前必须回查山东省教育招生考试院官方页面或公告
